...
/**
 * Create the predicate with random seeds
 */
...
template <typename Domain, typename Predicate, typename Metric, typename Image>
void rasterScan(const  Domain &aDomain,
