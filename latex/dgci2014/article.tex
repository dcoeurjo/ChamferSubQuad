...
\begin{figure}
  \begin{center}
    \subfigure[]{ \begin{overpic}[width=4cm]{figs/hiddenByTrue}
    \put(32,5){$a$}
    \put(5,35){$b$}
    \put(25,75){$c$}
    \put(60,-10){$S$}
    \end{overpic}}
    \subfigure[]{\begin{overpic}[width=4cm]{figs/hiddenByFalse}
    \put(37,8){$a$}
    \put(23,37){$b$}
    \put(35,72){$c$}
    \put(60,-10){$S$}
      \end{overpic}}~~~~~~~~~~
    \subfigure[]{\begin{overpic}[width=2.1cm]{figs/closest}
    \put(-5,52){$a$}
    \put(2,78){$b$}
    \put(47,55){$c$}
    \put(38,-10){$S$}
