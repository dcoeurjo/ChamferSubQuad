...
\begin{figure}[htbp]
  \begin{center}
    \subfigure[]{
      \begin{overpic}[width=3.2cm]{init}
        \put(-5,60){$a$}
        \put(85,40){$b$}
        \put(42,105){$S$}
      \end{overpic}
    ...
    \subfigure[]{
      \begin{overpic}[width=3.2cm]{algoMid}
      \put(-5,60){$a$}
        \put(85,40){$b$}
        \put(42,105){$S$}
        \put(12,60){$\vec{v_{mid}}$}
        \put(13,80){$\vec{v_{mid+1}}$}
        \put(-5,98){$\vec{v_j}$}
        \put(5,35){$\vec{v_i}$}
        \put(50,90){$p_{mid+1}$}
        \put(50,58){$p_{mid}$}
    ...
    \subfigure[]{
      \begin{overpic}[width=3.2cm]{algoEnd}
      \put(-5,60){$a$}
        \put(85,40){$b$}
        \put(42,105){$S$}
        \put(50,50){$e$}
        \put(10,50){$\vec{v_{k}}$}
        \put(11,70){$\vec{v_{k+1}}$}
        \put(60,40){$\vec{v_j}$}
        \put(67,57){$\vec{v_{j+1}}$}
      \end{overpic}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \subfigure[]{\includegraphics[width=2.8cm]{figs/image-voro-chamf_5711}}
    \subfigure[]{\includegraphics[width=2.8cm]{figs/image-dt-chamf_5711}}
    \subfigure[]{\includegraphics[width=2.8cm]{figs/image-voro-chamf_5711-2}}
    \subfigure[]{\includegraphics[width=2.8cm]{figs/image-dt-chamf_5711-2}}\\
    \subfigure[]{\includegraphics[width=2.8cm]{figs/image-voro-chamf_l_2}}
    \subfigure[]{\includegraphics[width=2.8cm]{figs/image-dt-chamf_l_2}}
    \subfigure[]{\includegraphics[width=2.8cm]{figs/image-voro-chamf_l_22}}
    \subfigure[]{\includegraphics[width=2.8cm]{figs/image-dt-chamf_l_22}}
  \end{center}
